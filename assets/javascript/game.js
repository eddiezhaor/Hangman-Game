var win=0;
var images=["assets/images/cat.jpg","assets/images/cat2.jpeg","assets/images/cat3.jpeg","assets/images/cat4.jpg"];
...
function displayimg(){
	...
	document.getElementById("myimg").innerHTML=`<img class="images" src="${images[num]}">`;
}
start();
